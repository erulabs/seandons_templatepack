...
app.controller('stencilController', [
  '$scope', function($scope) {
    ...
    $scope.selectStencil = function(name) {
      ...
      $scope.numStencils++;
      return $scope.buildManifest();
    };
    $scope.removeStencil = function(name) {
      $scope.selectedStencils[name] = void 0;
      delete $scope.selectedStencils[name];
      $scope.numStencils--;
      return $scope.buildManifest();
    };
    $scope.openStencilOptions = function(name) {
      return $scope.selectedStencils[name].open = true;
    };
    $scope.closeStencilOptions = function(name) {
      return $scope.selectedStencils[name].open = false;
    };
    ...
    return $scope.buildManifest = function() {
      var name, obj, optName, option, output, ref, ref1, stencil;
      output = {
        name: "My_new_cookbook",
        stencils: []
      };
      ref = $scope.selectedStencils;
      for (name in ref) {
        stencil = ref[name];
        obj = {
          stencil_set: name
        };
        ref1 = stencil.options;
        for (optName in ref1) {
          option = ref1[optName];
      ...
      return $scope.manifest_output = $scope.prettyJson(output);
    };
  }
]);
...
},{"../manifest.json":3,"../stencils/apache/manifest.json":4,"../stencils/application-node/manifest.json":5,"../stencils/application-php/manifest.json":6,"../stencils/drupal/manifest.json":7,"../stencils/elk/manifest.json":8,"../stencils/glusterfs/manifest.json":9,"../stencils/graphite/manifest.json":10,"../stencils/ha-redis/manifest.json":11,"../stencils/haproxy/manifest.json":12,"../stencils/iojs/manifest.json":13,"../stencils/mariadb-galera/manifest.json":14,"../stencils/mariadb/manifest.json":15,"../stencils/memcached/manifest.json":16,"../stencils/newrelic/manifest.json":17,"../stencils/nginx/manifest.json":18,"../stencils/nodejs/manifest.json":19,"../stencils/php/manifest.json":20,"../stencils/rackspace_networks/manifest.json":21,"../stencils/rails/manifest.json":22,"../stencils/redis/manifest.json":23,"../stencils/ruby/manifest.json":24,"../stencils/statsd/manifest.json":25,"../stencils/varnish/manifest.json":26,"../stencils/wordpress/manifest.json":27,"./build/angular.min.js":2}],2:[function(require,module,exports){
/*
 AngularJS v1.3.14
...
module.exports={
  ...
  "stencil_sets": {
    ...
    "ha-redis": {
      "help": "Creates a highly available Redis & HAProxy recipe"
    },
    "memcached": {
    ...
    "mysql": {
      "help": "Creates some MySQL recipes"
    },
    "newrelic": {
      "help": "Basic newrelic"
    },
    "postgres": {
      "help": "Creates a postgres recipe"
    },
    "php": {
